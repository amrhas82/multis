...
- [rag.md](02-features/rag.md) — Document indexing and LLM RAG pipeline
- [chat-modes.md](02-features/chat-modes.md) — Personal vs business chat modes

### [03-logs/](03-logs/) — What Changed Over Time
- [implementation-log.md](03-logs/implementation-log.md) — POC completion history
- [decisions-log.md](03-logs/decisions-log.md) — Key decisions and rationale
- [bug-log.md](03-logs/bug-log.md) — Bugs encountered and fixes
- [validation-log.md](03-logs/validation-log.md) — Testing and validation results
...
- [POC_PLAN.md](archive/POC_PLAN.md) — Original POC plan (moved to prd)
- [MULTI_PLATFORM_PLAN.md](archive/MULTI_PLATFORM_PLAN.md) — Original platform plan (moved to features)
